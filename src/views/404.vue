<template>
  <main class="h-screen w-full flex flex-col justify-center items-center">
    ...
    <div
      class="bg-secondary text-primary px-2 text-sm rounded rotate-12 absolute"
    >
      Page Not Found
    </div>
    <router-link to="/">
      <button class="mt-5">
        <a
          class="relative inline-block text-sm font-medium text-secondary group active:text-secondary-secondary"
        >
          <span
          ...
          <span
            class="relative block px-8 py-3 bg-primary border border-current"
          >
            Go Home
          </span>
        </a>
